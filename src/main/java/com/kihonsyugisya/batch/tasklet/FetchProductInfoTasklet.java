...
//            chunkContext.getStepContext().getStepExecution().getExecutionContext().put(ExecutionContextKeys.FILTERED_ITEM_1.getKey(), filteredItem);
//            System.out.println("Filtered item saved to ExecutionContext.");
//        } else {
